  ...
  return (
    <div className="py-4">
      ...
      <div className="relative mb-4 pl-4 pb-6 pr-[119px] rounded-xl border-[0.5px] border-black/8 shadow-xs bg-gray-50 overflow-hidden">
        <div
          className={`${s.mask} absolute top-0 left-0 w-full -bottom-2 z-10`}
        ></div>
        ...
        <div className="flex items-center h-5 justify-between">
          ...
          {!webappBrandRemoved && (
            <div className="flex items-center text-[10px] font-medium text-gray-400">
              ...
              {webappLogo ? (
                <img
                  src="/koality-technology-logo.png"
                  alt="Koality Technology"
                  className="ml-2 block w-auto h-5"
                />
              ) : (
                <img
                  src="/koality-technology-logo.png"
      ...
      >
        <div>
          ...
          <div className="leading-[18px] text-xs text-gray-500">
